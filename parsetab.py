...
_lr_productions = [
  ...
  ('calc -> expression','calc',1,'p_calc','main.py',69),
  ('calc -> var_assign','calc',1,'p_calc','main.py',70),
  ('calc -> empty','calc',1,'p_calc','main.py',71),
  ('var_assign -> NAME EQUALS expression','var_assign',3,'p_var_assign','main.py',86),
  ('expression -> expression MULTIPLY expression','expression',3,'p_expression','main.py',92),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','main.py',93),
  ...
  ('expression -> INT','expression',1,'p_expression_int_float','main.py',101),
  ('expression -> FLOAT','expression',1,'p_expression_int_float','main.py',102),
  ('expression -> NAME','expression',1,'p_expression_var','main.py',108),
  ('empty -> <empty>','empty',0,'p_empty','main.py',117),
]
